...
export default function MojoInlineChat() {
  ...
  return (
    <section id="mojo-hero" className="relative pt-8 pb-16 md:pt-12 md:pb-24 px-4 overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        {hasConversation && (
          <div className="max-w-xl mx-auto mb-6">
            <div
              ...
              className="max-h-[50vh] overflow-y-auto px-2 py-3 space-y-3 rounded-2xl bg-gray-50/80 border border-border/50"
            >
        ...
        {/* Quick search chips — show when no active conversation or at trade step */}
        {(!hasConversation || step === 'trade') && (
          <div className="flex flex-wrap justify-center gap-2 mb-8 max-w-xl mx-auto">
            {POPULAR_TRADE_CHIPS.slice(0, 5).map((chip) => (
              <button
                key={chip.label}
                onClick={() => handleQuickChip(`${chip.emoji} ${chip.label}`)}
